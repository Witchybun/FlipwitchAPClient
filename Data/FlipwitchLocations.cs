...
namespace FlipwitchAP.Data
{
    public static class FlipwitchLocations
    {
        ...
        public static readonly List<LocationData> APLocationData = new()
        {
            ...
            CreateLocation(70, "ST: Shop Item 2", "HealthNecklace", SHOP),
            ...
            CreateLocation(75, "ST: Fashion Shop 2", "CatCostume", SHOP),
            ...
            CreateLocation(405, "FF: Fungal Deal", "DummyFD", QUEST, secondaryCallName: "FungalForestDeed"),
            ...
            CreateLocation(605, "Fairy: Fairy Mushroom", "Fairy Mushroom", QUEST),  
            CreateLocation(606, "Goblin Princess: Goblin Stud", "Goblin Stud", QUEST),  
            CreateLocation(607, "MomoRobo: Out of Service", "Out of Service", QUEST),  
            CreateLocation(608, "Bunny Club: The Bunny Club", "The Bunny Club", QUEST),  
            CreateLocation(609, "Bunny Club: Find the Silky Slime", "Find the Silky Slime", QUEST),  
            CreateLocation(610, "Milk & Cream: Panty Raid", "Panty Raid", QUEST),  
            CreateLocation(611, "Unlucky Cat Statue: Unlucky Cat", "Unlucky Cat", QUEST),  
            CreateLocation(612, "Annahell: Harvest Season", "Harvest Season", QUEST),  
            CreateLocation(613, "Gabrielle: Long Distance Relationship", "Long Distance Relationship", QUEST),  
            CreateLocation(614, "Natasha: Summoning Stones", "Summoning Stones", QUEST),  
            CreateLocation(615, "Keroku: Seamen, With an A", "Seamen, With an A", QUEST),  
            CreateLocation(616, "Ratchel: Cardio Day", "Cardio Day", QUEST),  
            CreateLocation(617, "Ancient Being: Stop Democracy", "Stop Democracy", QUEST),  
            CreateLocation(618, "Clinic: Medical Emergency", "Medical Emergency", QUEST),  
            CreateLocation(619, "Rover: Let the Dog Out", "Let the Dog Out", QUEST),  
            CreateLocation(620, "Cabaret Cafe: Rat Problem", "Rat Problem", QUEST),  
            CreateLocation(621, "Cabaret Cafe: Ghost Hunters", "Ghost Hunters", QUEST),  
            CreateLocation(622, "Cabaret Cafe: Haunted Bathroom", "Haunted Bathroom", QUEST),  
            CreateLocation(623, "Cabaret Cafe: Ectogasm", "Ectogasm", QUEST),  
            CreateLocation(624, "Cabaret Cafe: Jelly Mushroom", "Jelly Mushroom", QUEST),  
            CreateLocation(625, "Cabaret Cafe: Booze Bunny", "Booze Bunny", QUEST),  
            CreateLocation(626, "Cabaret Cafe: Help Wanted", "Help Wanted", QUEST),  
            CreateLocation(627, "Cabaret Cafe: Deluxe Milkshake", "Deluxe Milkshake", QUEST),  
            CreateLocation(628, "Cabaret Cafe: Boned", "Boned", QUEST),  
            CreateLocation(629, "Cabaret Cafe: Legendary Chewtoy", "Legendary Chewtoy", QUEST),  
            CreateLocation(630, "Pig Mansion: Tatil's Tale", "Tatil's Tale", QUEST),  
            CreateLocation(631, "Pig Mansion: Signing Bonus", "Signing Bonus", QUEST),  
            CreateLocation(632, "Leg's Office: Emotional Baggage", "Emotional Baggage", QUEST),  
            CreateLocation(633, "Leg's Office: Dirty Debut", "Dirty Debut", QUEST),  
            CreateLocation(634, "Kyoni's Shop: Belle's Milkshake", "Belle's Milkshake", QUEST),  
            CreateLocation(635, "Kyoni's Shop: Devilicious", "Devilicious", QUEST),  
            CreateLocation(636, "Kyoni's Shop: What's a Daikon?", "What's a Daikon?", QUEST),  
            CreateLocation(637, "Dusty: Alley Cat", "Alley Cat", QUEST),  
            CreateLocation(638, "Cult of Whorus: Priestess of Whorus", "Priestess of Whorus", QUEST),  
            CreateLocation(639, "Cult of Whorus: A Priest's Duties", "A Priest's Duties", QUEST),  
