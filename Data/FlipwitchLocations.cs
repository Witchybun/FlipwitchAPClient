...
namespace FlipwitchAP.Data
{
    public static class FlipwitchLocations
    {
        ...
        public static readonly List<LocationData> APLocationData = new()
        {
            ...
            CreateLocation(91, "ST: Special Milkshake", "DummyBM", QUEST, secondaryCallName: "BelleMilkshake"),
            ...
            CreateLocation(162, "GC: Hidden Wall", "gc_windowroom_coins", COINCHEST),
            ...
            CreateLocation(167, "GC: Hidden Shrub", "gc_dropdown_coins", COINCHEST),
            ...
            CreateLocation(356, "AH: Elf Merchant Chest", "t_behindcloud_coins", COINCHEST),
            ...
            CreateLocation(405, "FF: Past Fungella", "238.5322-40.318542_TinyRoomWorldMana Upgrade (1)", STAT),
            CreateLocation(406, "FF: Heavenly Daikon", "HeavenlyDaikon", CHEST),
            CreateLocation(407, "FF: Past Chaos Fight", "ff_movingplatforms_coins", COINCHEST),
            CreateLocation(408, "FF: Closed Off Coins", "ff_plummet_coins", COINCHEST),
            CreateLocation(409, "FF: Between The Thorns", "ff_circleback_coins", COINCHEST),
            CreateLocation(410, "FF: Elf Merchant Item 1", "MagicalMushroom", SHOP),
            CreateLocation(411, "FF: Elf Merchant Item 2", "RingofSun", SHOP),
            CreateLocation(412, "FF: Elf Merchant Chest", "sc_woodplatform_coins", COINCHEST),
            CreateLocation(413, "FF: Guarded by Mushrooms", "ff_mushroomtower_coins", COINCHEST),
            CreateLocation(414, "FF: Fungal Gauntlet", "306.7147-38.2432619_MushroomClimbWorldHealth Upgrade (1)", STAT),
            CreateLocation(415, "FF: Blue Jelly Mushroom Chest", "GlassWand", CHEST),
            CreateLocation(416, "FF: Fungal Door Key Chest", "ForgottenFungalDoorKey", CHEST),
            CreateLocation(417, "FF: Secret Fungus Room", "ff_secretarea_gacha", GACHA),
            CreateLocation(418, "FF: Slime Form Chest", "SlimeTransform", CHEST),
            CreateLocation(419, "FF: Slime Citadel Key Chest", "SlimeCitadelKey", CHEST),
            CreateLocation(420, "FF: Fungal Deed", "DummyFD", QUEST, secondaryCallName: "FungalForestDeed"),
