...
namespace FlipwitchAP.Data
{
    public static class FlipwitchLocations
    {
        ...
        public static readonly List<LocationData> APLocationData = new()
        {
            ...
            CreateLocation(483, "Kyoni's Shop: Belle's Milkshake", "Belle's Milkshake", QUEST),  
            CreateLocation(484, "Kyoni's Shop: Devilicious!", "Devilicious", QUEST),  
            CreateLocation(485, "Kyoni's Shop: What's a Daikon?", "What's a Daikon?", QUEST),  
            CreateLocation(486, "Dusty: Alley Cat", "Alley Cat", QUEST),  
            CreateLocation(487, "Cult of Whorus: Priestess of Whorus", "Priestess of Whorus", QUEST),  
            CreateLocation(488, "Cult of Whorus: A Priest's Duties", "A Priest's Duties", QUEST),  
            CreateLocation(489, "Goblin Princess: Goblin Stud", "Goblin Stud", QUEST),
            CreateLocation(490, "WW: Belle's Cowbell Chest", "Cowbell", CHEST),
            CreateLocation(491, "WW: Gobliana's Belongings", "DummyGB", QUEST, secondaryCallName: "GoblinModelLuggage"),
            CreateLocation(492, "WW: Red Wine Chest", "Wine", CHEST),
            CreateLocation(493, "WW: Legs' Business Offer", "Dummy1", QUEST, secondaryCallName: "GoblinBusinessCard"),
            CreateLocation(494, "WW: Gobliana's Headshot", "", QUEST, secondaryCallName: "GoblinHeadshot"),
            CreateLocation(495, "ST: Cabaret Cafe Girls Room Chest", "sc_cabaret_coins", COINCHEST),
            CreateLocation(496, "ST: Cabaret Cafe Delicious Milk", "DummyDM", QUEST, secondaryCallName: "DeliciousMilk"),
            CreateLocation(497, "ST: Cabaret Cafe Cherry Apartment Key", "DummyCK", QUEST, secondaryCallName: "CherryKey"),
            CreateLocation(498, "ST: Cabaret Cafe VIP Chest", "BunnyCostume", CHEST),
            CreateLocation(599, "ST: Leg's Office Goblin Apartment Key", "DummyGAK", QUEST, secondaryCallName: "GoblinModelApartmentKey"),
            CreateLocation(500, "ST: MomoRobo Server Password", "DummyMBAP", QUEST, secondaryCallName: "MomoBotAdminPassword"),
            CreateLocation(501, "ST: Pig Mansion Fungal Key", "DummyFK", QUEST, secondaryCallName: "FungalKey"),
            CreateLocation(502, "ST: Pig Mansion Maid Contract", "MaidContract", CHEST),
            CreateLocation(503, "ST: Special Milkshake", "DummyBM", QUEST, secondaryCallName: "BelleMilkshake"),
            CreateLocation(504, "GC: Willow The Whiff", "CatGirlsClothes", CHEST),
            CreateLocation(505, "JG: Nearby Cat Shrine", "DummySF3", QUEST, secondaryCallName: "SoulFragment3"),
            CreateLocation(506, "JG: Northern Cat Shrine", "DummySF1", QUEST, secondaryCallName: "SoulFragment1"),
            CreateLocation(507, "CD: Cat Shrine", "DummySL2", QUEST, secondaryCallName: "SoulFragment2"),
            CreateLocation(508, "CD: Demon Letter", "DummyDL", QUEST, secondaryCallName: "DemonLetter"),
            CreateLocation(509, "AH: Cloudia", "LegendaryHalo", CHEST),
            CreateLocation(510, "AH: Angel Letter", "DummyAL", QUEST, secondaryCallName: "AngelLetter"),
            CreateLocation(511, "FF: Heavenly Daikon", "HeavenlyDaikon", CHEST),
            CreateLocation(512, "FF: Blue Jelly Mushroom Chest", "GlassWand", CHEST),
            CreateLocation(513, "FF: Fungal Deed", "DummyFD", QUEST, secondaryCallName: "FungalForestDeed"),
            CreateLocation(514, "SC: Silky Slime Chest", "SilkySlime", CHEST),
            CreateLocation(515, "SC: Silky Slime Summoning Stone", "DummySS3", QUEST, secondaryCallName: "SummonStone3"),
            CreateLocation(516, "SC: Secret Room Past Spring Summoning Stone", "DummySS1", QUEST, secondaryCallName: "SummonStone1"),
            CreateLocation(517, "SC: Slurp Summoning Stone", "DummySS2", QUEST, secondaryCallName: "SummonStone2"),
            CreateLocation(518, "WW: Mimic Chest Key Room Chest 2", "MimicKey", CHEST),
            CreateLocation(519, "ST: Abandoned Homes 02 House Chest", "AbandonedApartmentKey", CHEST),
            CreateLocation(520, "ST: Chaos Fight", "HellishDango", CHEST),
